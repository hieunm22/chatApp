<?php
    ...
    $sql = "INSERT INTO `conversions_list`(`user1_id`, `user2_id`) 
SELECT * FROM (SELECT ".$user_id.", ".$friend_id.") AS tmp
WHERE NOT EXISTS (
    SELECT * FROM conversions_list WHERE (user1_id=".$user_id." AND user2_id=".$friend_id.") or (user1_id=".$friend_id." AND user2_id=".$user_id.")
) LIMIT 1";
