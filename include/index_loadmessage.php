<?php
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        $icon = $stt;
        switch ($stt) {
            case 0: $icon = '<span class="_2her _3zzf" title="Sending"></span>';
                break;
            case 1: $icon = '<span class="_2her _3zzf" title="Sent"><i aria-label="Sent" aria-roledescription="Status icon" class="_57e_" role="img"></i></span>';
                break;
            case 2: $icon = '<span class="_2her _9ah" title="Delivered"><i aria-label="Delivered" aria-roledescription="Status icon" class="_57e_" role="img"></i></span>';
                break;
            case 3: $icon = '<span class="_2her _9ah" title="Seen"></span>';
                break;
        }
