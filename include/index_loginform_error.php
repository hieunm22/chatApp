<form action="" method="post">
	<div class="cont">
		...
		<div class="login-info">
			...
			<input type="text" name="username" id="usr" placeholder="User name, email hoặc số điện thoại" required autofocus="true" />
		</div>
		<div class="login-info">
			<svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
				<path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0"></path>
			</svg>
			<input type="password" name="password" id="pwd" placeholder="Mật khẩu" required oninvalid="enterPwd(this)"/>
		</div>
