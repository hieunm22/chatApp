		<form action="" method="post">
			...
			<div class="login-info"><span class="lbl login">Password </span><input type="password" name="password" id="pwd" placeholder="Mật khẩu" required oninvalid="enterPwd(this)"/></div>
