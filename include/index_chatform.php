                    ...
                    <tr>
                        ...
                        <td id="colorpicker" width="32px" align="right">
							...
							<div id="myDropdown" class="dropdown-content">
								<a class="dropdown-row" id="row1" aria-label="Conversation color" role="button" title="Conversation color" aria-expanded="false" data-testid="info_panel_button1" data-toggle="modal" data-target="#myModal">Đổi màu cuộc hội thoại</a>
